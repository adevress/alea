...
inline alea::sha1::digest32_t generate_deterministic_seed_160(Uint origin_seed, Uint key) {
...
/*
    ...
    alea::sha1::digest32_t digest = impl::generate_deterministic_seed_160<typename Engine::result_type>(old_val, key);
