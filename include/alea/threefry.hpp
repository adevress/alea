...
template<bool flag = false> void static_no_match() { static_assert(flag, "not a valid match"); }
...
class threefry {
  ...
  public:
    ...
    inline range_type operator()(const domain_type& counter) {
        ...
        ks[N] = utils::accumulate(k.begin(), k.end(), uint_ks_parity<Uint>(), utils::bit_xor<uint_type>());
